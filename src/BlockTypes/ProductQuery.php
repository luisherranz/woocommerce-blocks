...
class ProductQuery extends AbstractBlock {
	...
	private function get_queries_by_applied_filters() {
		return array(
			...
			'attribute_filter' => $this->get_filter_by_attribute_query(),
		);
	}
	...
	/**
	 * Return a query that filters products by attribute.
	 *
	 * @return array
	 */
	private function get_filter_by_attribute_query() {
